/**
 * Weather & Map Section for Better Malolos Homepage
 * Displays real-time weather data and interactive map of Malolos, Bulacan
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in Malolos">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> Malolos, Bulacan
                            </div>
                        </div>
                    </div>
