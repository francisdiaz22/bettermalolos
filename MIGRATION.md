...
This document provides guidance for contributors migrating from the static HTML version to the React + TypeScript version of BetterMalolos.org.

## Overview

BetterMalolos.org now has two versions:
